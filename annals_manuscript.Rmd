...
p3 <<-plot_grid(title,p,p1, align = "v" , ncol = 1, labels = c('','A', 'B'),rel_heights = c(0.1, 1,1.2))
plot(p3)
...
pseq.meta <- meta(pseq.subset)
  ...
  p3 <<-plot_grid(p1,p2, align = "v" , ncol = 1, axis = 'tblr', labels = c('C', 'E'),rel_heights = c(5,5,5))
...
p4 <<-plot_grid(p1,p2, align = "v" , ncol = 1, axis = 'tblr', labels = c('D', 'F'),rel_heights = c(5,5,5))
  
print(p4)
  

  
p6 <<-plot_grid(p3,p4, align = "v" , ncol = 2, rel_heights = c(10,10,10))
...
p <- plot.p.new.rel + scale_fill_manual(values=c( "#A5CEE3", "#1F78B4", "#34A02C", "#E3211D", "#FF7E00", "blue", "yellow", "red"))
...
p1 <- plot.p.new.rel + scale_fill_brewer(palette = "Paired")
...
p7 <<-plot_grid(p,p1, align = "v" , ncol = 2, labels = c('A', 'B'),rel_heights = c(10,10,10))
plot(p7)



p8 <<-plot_grid(p7, p6, align = "v" , nrow = 2, rel_heights = c(10,30,30))
...
perm <- plot_grid(p,p2, align = "v" , ncol = 1, axis = 'tblr', labels = c('A', 'B'),rel_heights = c(10,10,10))
