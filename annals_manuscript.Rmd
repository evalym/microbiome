...
atlas.pseq <- subset_samples(atlas.pseq, !is.na(mnd))
...
plot.p.new.rel <- plot_composition(p.new.rel, average_by = "mnd", x.label = " ", plot.type = "barplot") + guides(fill=guide_legend(title="Phylum")) + theme(legend.text = element_text( face="italic")) + theme_classic()
...
abundance.bar(pseq.subset, "pseq_bar")
