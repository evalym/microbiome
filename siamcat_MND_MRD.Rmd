...
```{r}
pseq.c <- microbiome::transform(pseq.1, "compositional")
```
...
check.confounders(siamcat,
    fn.plot = 'conf_checkMND.pdf', meta.in = c("mnd", "age", "gender", "BMI", "age_category", "born_method", "feeding_practice"))
