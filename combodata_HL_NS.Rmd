...
c.mnd.nationality <- fct_collapse(c.mnd.atlas, LOW = c("Scandinavia") , MEDIUM = c("SouthEurope"), HIGH = c("CentralEurope","US","UKIE") )
...
a.mnd.nationality <- fct_collapse(a.mnd.nationality, LOW = c("EasternEurope","SouthEurope") ,  HIGH = c("CentralEurope","US","UKIE","Scandinavia") )

# reorder
a.mnd.nationality <- factor(a.mnd.nationality, levels = (c("LOW", "HIGH")))
...
add_header_above(c("Location" = 1, "15-49" = 2, "50-69" = 2, "70+" = 2)) %>%
  ...
  pack_rows("Low MND group",1,2)%>%
  pack_rows("High MND group", 3,6) 
...
alpha_d_two(pseq,"final_RLWT_1") 

pre_perma_d_two(atlas.pseq) 
perma_d_two("RLWT_highVlow")
