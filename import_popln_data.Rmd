...
# For MND
mnd.incidence <- as.data.frame(read_csv("MND-I-B.csv",col_names = TRUE))
mnd.prev <- as.data.frame(read_csv("MND-P-B.csv",col_names = TRUE))
...
mnd.ip <- right_join(mnd.prev, mnd.incidence, by = "Location")

# For IPD
ipd.incidence <- as.data.frame(read_csv("PD-I-B.csv",col_names = TRUE))
ipd.prev <- as.data.frame(read_csv("PD-P-B.csv",col_names = TRUE))
...
ipd.ip <- right_join(ipd.prev, ipd.incidence, by = "Location")

# For AD
ad.incidence <- as.data.frame(read_csv("AD-I-B.csv",col_names = TRUE))
ad.prev <- as.data.frame(read_csv("AD-P-B.csv",col_names = TRUE))
...
ad.ip <- right_join(ad.prev, ad.incidence, by = "Location")
