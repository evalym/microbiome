...
ggplot(mnd.i.melt, aes(x = variable, y = value, colour = Location)) + 
  geom_line() + 
...
ggplot(mnd.p.melt, aes(x = variable, y = value, colour = Location)) + 
  geom_line() + 
...
ggplot(ipd.i.melt, aes(x = variable, y = value, colour = Location)) + 
  geom_line() + 
...
ggplot(ipd.p.melt, aes(x = variable, y = value, colour = Location)) + 
  geom_line() + 
...
ggplot(ad.i.melt, aes(x = variable, y = value, colour = Location)) + 
  geom_line() + 
...
ggplot(ad.p.melt, aes(x = variable, y = value, colour = Location)) + 
  geom_line() + 
