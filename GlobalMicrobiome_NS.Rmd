...
# samplename <- sample_names(pseq)[,"Eggerthella lenta et rel."]

# Pick abundances for a particular taxon
# eg.abundances <- abundances(pseq, transform='compositional')[, samplename]
