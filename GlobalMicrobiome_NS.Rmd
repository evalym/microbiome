...
p2 + scale_colour_manual(values = c("yellow", "orange", "red", "grey")) + facet_wrap(~mnd, nrow = 2) + labs(color = "PD Prevalence")
ggsave("NMDS_facetpd.png")

p3 = plot_ordination(pseq.rel, pseq.ord, type = "sample", color = "pd")
plot(p3 + scale_colour_manual(values = c("yellow", "orange", "red", "grey")) + labs(color = "PD Prevalence"))
ggsave("NMDStpd.png")

p3 + scale_colour_manual(values = c("yellow", "orange", "red", "grey")) + facet_wrap(~mnd, nrow = 2) + labs(color = "PD Prevalence")
ggsave("NMDS_facetpd.png")
...
p3 + scale_colour_manual(values = c("yellow", "orange", "red", "grey")) + facet_wrap(~pd, 3) + labs(color = "AD Prevalence")
